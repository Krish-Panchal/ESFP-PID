...
char selectnft()
{
	int select;
	printf("\n\n\nSelect NFT:-\n");
	printf("\nPress 1 to Buy Handcraft#1102\t");
    printf("Press 2 to Buy Pottery#2069\t");
    printf("Press 3 to Buy Paiting#1166\t");
    printf("Press 4 to Buy TraditionalDesign#6666\t");
    printf("Press 5 to Buy Sidisaiyedjali#1234\n");
    printf("\nPress 0 to Exit\n");
    printf("\nEnter Your Choice:");
    scanf("%d",&select);
    switch(select)
...
char SELL()
{
    int choice2;
	printf("\n\n\nSelect NFT:-\n");
	printf("\nPress 1 to Sell Handcraft#1102\t");
    printf("Press 2 to Sell Pottery#2069\t");
    printf("Press 3 to Sell Paiting#1166\t");
    printf("Press 4 to Sell TraditionalDesign#6666\t");
    printf("Press 5 to Sell Sidisaiyedjali#1234\n");
    printf("\nPress 0 to Exit\n");
    printf("\nEnter Your Choice:");
    scanf("%d",&choice2);
    switch(choice2)
